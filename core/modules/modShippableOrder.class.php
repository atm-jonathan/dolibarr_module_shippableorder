...
/**
 * 	\defgroup   shippableorder     Module ShippableOrder
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/shippableorder/core/modules directory.
 *  \file       htdocs/shippableorder/core/modules/modShippableOrder.class.php
 *  \ingroup    shippableorder
 *  \brief      Description and activation file for module ShippableOrder
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module ShippableOrder
 */
class modShippableOrder extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->numero = 104050; // 104000 to 104999 for ATM CONSULTING
		...
		$this->picto='shippableorder@shippableorder';
		...
		// Config pages. Put here list of php page, stored into shippableorder/admin directory, to use to setup module.
	...
	function init($options='')
	{
		...
		$result=$this->_load_tables('/shippableorder/sql/');
